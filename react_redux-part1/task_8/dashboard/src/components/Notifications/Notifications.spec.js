...
describe('Notifications Component', () => {
  ...
  test('simulates closing the drawer and sets displayDrawer to false', () => {
    const handleHideDrawer = jest.fn();
    render(<Notifications displayDrawer={true} notifications={mockNotifications} handleHideDrawer={handleHideDrawer} />);
  ...
  test('simulates opening the drawer and sets displayDrawer to true', () => {
    const handleDisplayDrawer = jest.fn();
    render(<Notifications handleDisplayDrawer={handleDisplayDrawer} />);
  ...
  test('simulates marking a notification as read and removes it from the list', () => {
    const markNotificationAsRead = jest.fn();
    render(
      <Notifications
        displayDrawer={true}
